  ...
  return (
    <div className="w-full h-24 sticky top-0 mx-auto z-50 bg-bodyColor flex justify-between items-center font-titleFont border-b-[1px] border-b-gray-600">
      ...
      <div>
        ...
        <span onClick={() => SetShowMenu(!showMenu)} className="text-xl mdl:hidden bg-black w-10 h-10 inline-flex justify-center items-center rounded-full text-designColor cursor-pointer">
          <FiMenu />
        </span>
        {showMenu && (
          <div className="w-[80%] h-screen overflow-scroll absolute top-0 left-0 bg-gray-900 p-4 scrollbar-hide">
            <div className="flex flex-col gap-8 py-2 relative">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit cupiditate quisquam expedita similique et quo quasi nam! Asperiores, nam soluta.</p>
              </div>
