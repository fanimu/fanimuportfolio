...
const ResumeCard = ({ title, subTitle, result, des }) => {
  return (
    <div className="w-full h-1/3 group flex">
      ...
      <div className="w-full bg-black bg-opacity-20 hover:bg-opacity-40 duration-300 rounded-lg lgl:px-10 p-4 flex flex-col gap-6 lgl:gap-10 justify-center shadow-shadowOne">
